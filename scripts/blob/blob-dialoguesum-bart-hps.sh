# Testing different learning rates for BLoB-dialoguesum-bart
...
for lr in 3e-4 5e-4 1e-3; do
    for sample in 10; do
        for seed in 1 2; do   # maybe only 2 seeds here to save compute
            name=$modelwrapper-dialoguesum-lr$lr-eps$eps-kllr$kllr-beta$beta-gamma$gamma-seed$seed
